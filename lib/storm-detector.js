...
function detectReflectivityObjects(field,options={}) {
  ...
  const lowerBoundValues=field.reflectivityLowerBoundDbz
  const estimateValues=field.reflectivityDbz

  const isLowerBound=
    lowerBoundValues!==undefined &&
    lowerBoundValues!==null

  const values=isLowerBound
    ? lowerBoundValues
    : estimateValues
